...
The value of this for us is that we can find the area under the curve between two values, and that area gives us the probability of an outcome falling within that range. This insight sets us up for much of the inferential statistics ahead. If a population can be reasonably modelled by a normal distribution, we can determine the probability associated with any region of scores without recording and counting every individual score.
