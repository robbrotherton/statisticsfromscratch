...
A Galton board, developed by Francis Galton in the 1870s and also called a quincunx or bean machine, is a board with rows of pegs. Balls drop in at the top, and every time a ball hits a peg, it bounces left or right, and on down to the next row, and so on. After bouncing through all the rows, each ball ends up in one of the slots at the bottom.
