...
{{< interactive-figure alphaCriticalRegion makeDistributionGraph options='{"color":"var(--sfs-null-color, currentColor)","distribution":"normal","style":"minimal","xAxis":true,"xDomain":[-4,4],"shade":{"tail":"right","alpha":0.05},"animate":true,"labels":{"x":"z"}}' fallback="Normal curve with the top five percent shaded as the critical region." >}}
...
{{< interactive-figure twoTailedCriticalRegions makeDistributionGraph options='{"color":"var(--sfs-null-color, currentColor)","distribution":"normal","style":"minimal","xAxis":true,"xDomain":[-4,4],"shade":{"tail":"two","alpha":0.05},"animate":true,"labels":{"x":"z"}}' fallback="Normal curve with 2.5 percent shaded in each tail for a two-tailed test." >}}
