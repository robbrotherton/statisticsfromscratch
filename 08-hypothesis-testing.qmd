...
{{< interactive-figure spidermenSamplingDistribution makeDistributionGraph options='{"distribution":"normal","mean":284,"sd":22.36,"xDomain":[150,352],"xTicks":8,"style":"minimal","xAxis":true,"shade":{"to":159},"markers":{"at":159,"label":"M = 159","height":0.45,"color":"var(--bc-accent, #2c7fb8)"},"animate":true,"labels":{"x":"Sample mean reaction time (ms), n = 5"}}' fallback="Sampling distribution of mean reaction times for samples of five, centered on 284 ms with standard error 22.36 ms; a vertical line marks the sample mean of 159 ms far down in the lower tail." >}}
