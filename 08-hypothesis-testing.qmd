...
Let's put this in terms of the radioactive spider-bite scenario from Chapter 5. Remember, some kid is bitten by a spider, which is theoretically expected to induce unusually fast reaction times. We were able to work out Peter Parker's $z$-score to describe where he fell in the population distribution---the original, untreated population of unbitten kids. His score looked a bit unusual, which we could take as evidence that he no longer belonged to that population. People as fast as him are rare in the population, so it's correspondingly unlikely he'd just happen to be that fast by chance. The treatment, the spider bite, seemed to have caused a difference.

But again, real research doesn't usually rely on examining just one individual. We usually want a *sample*---a bunch of kids who we treated to radioactive spider bites to see if it would alter their reaction times. Obviously in the real world this experiment probably would not make it past the ethics board, but the Spiderverse™️ provides just such a scenario.
