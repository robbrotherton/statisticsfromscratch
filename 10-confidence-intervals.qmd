...
{{< interactive-figure
  ...
  options='{
    ...
    "shade": {"tail": "center", "p": 0.95, "color": "var(--sfs-comparison-color, #2f6f9f)", "opacity": 0.3},
    "markers": {"at": 0, "label": "Point estimate", "color": "var(--sfs-comparison-color, #2f6f9f)", "labelColor": "var(--sfs-text, currentColor)"},
...
{{< interactive-figure
  ...
  options='{
    ...
    "shade": {"tail": "center", "p": 0.95, "color": "var(--sfs-comparison-color, #2f6f9f)", "opacity": 0.3},
    "markers": [
      {"at": 0, "labelMarkup": "*M*", "color": "var(--sfs-comparison-color, #2f6f9f)", "labelColor": "var(--sfs-text, currentColor)"},
...
{{< interactive-figure
  ...
  options='{
    ...
    "shade": {"from": 302.16, "to": 343.02, "color": "var(--sfs-comparison-color, #2f6f9f)", "opacity": 0.3},
    "markers": [
      {"at": 322.59, "label": "M = 322.59", "color": "var(--sfs-comparison-color, #2f6f9f)", "labelColor": "var(--sfs-text, currentColor)"},
...
::: {.sfs-figure-row}
{{< interactive-figure ciWidth80 makeDistributionGraph options='{"distribution":"normal","mean":322.59,"sd":10.43,"style":"minimal","xAxis":true,"xDomain":[280,365],"xTicks":5,"title":"80% confidence","shade":{"from":309.25,"to":335.94,"color":"var(--sfs-comparison-color, #2f6f9f)","opacity":0.3,"labelPosition":"above","label":"[309.2, 335.9]"}}' fallback="Normal curve for the class data with the narrower 80% confidence interval from 309.2 to 335.9 shaded." >}}

{{< interactive-figure ciWidth95 makeDistributionGraph options='{"distribution":"normal","mean":322.59,"sd":10.43,"style":"minimal","xAxis":true,"xDomain":[280,365],"xTicks":5,"title":"95% confidence","shade":{"from":302.16,"to":343.02,"color":"var(--sfs-comparison-color, #2f6f9f)","opacity":0.3,"labelPosition":"above","label":"[302.2, 343.0]"}}' fallback="The same normal curve with the wider 95% confidence interval from 302.2 to 343.0 shaded." >}}
:::
...
::: {.sfs-figure-row}
{{< interactive-figure ciWidthN23 makeDistributionGraph options='{"distribution":"normal","mean":322.59,"sd":10.43,"style":"minimal","xAxis":true,"xDomain":[280,365],"xTicks":5,"yDomain":[0,0.088],"title":"n = 23","shade":{"from":302.16,"to":343.02,"color":"var(--sfs-comparison-color, #2f6f9f)","opacity":0.3,"labelPosition":"above","label":"[302.2, 343.0]"}}' fallback="Sampling distribution for samples of 23 with the 95% confidence interval from 302.2 to 343.0 shaded." >}}

{{< interactive-figure ciWidthN100 makeDistributionGraph options='{"distribution":"normal","mean":322.59,"sd":5,"style":"minimal","xAxis":true,"xDomain":[280,365],"xTicks":5,"yDomain":[0,0.088],"title":"n = 100","shade":{"from":312.79,"to":332.39,"color":"var(--sfs-comparison-color, #2f6f9f)","opacity":0.3,"labelPosition":"above","label":"[312.8, 332.4]"}}' fallback="A taller, narrower sampling distribution for samples of 100 with a correspondingly narrower 95% confidence interval from 312.8 to 332.4." >}}
:::
...
::: {.sfs-figure-row}
{{< interactive-figure ciWidthSigma50 makeDistributionGraph options='{"distribution":"normal","mean":322.59,"sd":10.43,"style":"minimal","xAxis":true,"xDomain":[280,365],"xTicks":5,"yDomain":[0,0.088],"title":"σ = 50","shade":{"from":302.16,"to":343.02,"color":"var(--sfs-comparison-color, #2f6f9f)","opacity":0.3,"labelPosition":"above","label":"[302.2, 343.0]"}}' fallback="Sampling distribution when the population standard deviation is 50, with the 95% confidence interval from 302.2 to 343.0 shaded." >}}

{{< interactive-figure ciWidthSigma25 makeDistributionGraph options='{"distribution":"normal","mean":322.59,"sd":5.21,"style":"minimal","xAxis":true,"xDomain":[280,365],"xTicks":5,"yDomain":[0,0.088],"title":"σ = 25","shade":{"from":312.37,"to":332.81,"color":"var(--sfs-comparison-color, #2f6f9f)","opacity":0.3,"labelPosition":"above","label":"[312.4, 332.8]"}}' fallback="A narrower sampling distribution when the population standard deviation is 25, with a 95% confidence interval from 312.4 to 332.8." >}}
:::
