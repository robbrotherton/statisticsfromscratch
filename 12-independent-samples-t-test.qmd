...
{{< interactive-figure
  ...
  options='{
    ...
    "shade": {"from": -3.19, "to": 1.19, "color": "var(--bc-comparison-color, #2f6f9f)", "opacity": 0.3, "labelPosition": "above", "label": "[-3.19, 1.19]"},
    "markers": {"at": 0, "label": "H0: 0", "height": 0.5, "color": "var(--bc-accent, #2c7fb8)"},
