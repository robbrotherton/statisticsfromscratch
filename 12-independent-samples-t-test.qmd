...
{{< interactive-figure independentSamplesCover makeSampleComparisonCover options='{}' fallback="Two differently colored block distributions building up from their baselines." >}}
...
So we decide on $\alpha$. For our purposes, we'll use the traditional .05. And we look up the $t$ distribution with eight degrees of freedom in the $t$ table, and we find that the critical $t$ score that cuts off the highest and lowest 5% of the distribution is 2.306.

{{< interactive-figure independentTCriticalTable makeTTable options='{"title":"t critical values (excerpt)","df":{"from":6,"to":10},"alphas":[0.1,0.05,0.025,0.01,0.005],"confidence":false,"selectedTail":"two","selected":{"df":8,"tail":"two","alpha":0.05}}' fallback="Excerpt of the t critical-value table for df 6 to 10, with the two-tailed alpha .05 value for df = 8, 2.306, highlighted." >}}
...
{{< interactive-figure
  ...
  options='{
    ...
    "shade": {"from": -3.19, "to": 1.19, "color": "var(--sfs-confidence-color, #2f6f9f)", "opacity": 0.3, "labelPosition": "above", "label": "[-3.19, 1.19]"},
