...
{{< interactive-figure relatedSamplesCover makeSampleComparisonCover options='{"related":true}' fallback="Two block distributions in distinct blue shades building up from paired observations." >}}
...
This will be good practice for seeing if you understand how to do it.
