...
{{< interactive-figure relatedAnovaCover makeDistributionFamilyCover options='{"distribution":"normal","renderer":"svg","distributions":[{"mean":-1.3,"sd":1,"color":"var(--graph-series-1, #0072b2)"},{"mean":0,"sd":1,"color":"color-mix(in srgb, var(--graph-series-1) 50%, var(--graph-series-6))"},{"mean":1.3,"sd":1,"color":"var(--graph-series-6, #56b4e9)"}],"xDomain":[-5,5],"separateFromCenter":true,"fillOpacity":0.48,"ariaLabel":"Three normal curves in distinct blue shades grow together from a shared baseline, then two move to either side."}' fallback="Three shaded normal curves in distinct blue shades grow at a shared center, then separate." >}}
