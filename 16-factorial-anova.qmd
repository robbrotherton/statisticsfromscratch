...
{{< interactive-figure factorialAnovaCover makeDistributionFamilyCover options='{"distribution":"normal","renderer":"svg","distributions":[{"mean":-1.8,"sd":1,"color":"var(--graph-series-1, #0072b2)"},{"mean":-0.6,"sd":1,"color":"var(--graph-series-5, #cc79a7)"},{"mean":0.6,"sd":1,"color":"var(--graph-series-1, #0072b2)"},{"mean":1.8,"sd":1,"color":"var(--graph-series-5, #cc79a7)"}],"xDomain":[-5.5,5.5],"separateFromCenter":true,"fillOpacity":0.48,"ariaLabel":"Four normal curves in alternating blue and reddish purple grow at a shared center, then separate into four positions."}' fallback="Four shaded normal curves in two alternating colors grow together, then separate." >}}
...
That's an impressive feat. It's the most mathematically complicated thing that we'll do as part of this course. It's worth working through the math by hand at least once to reinforce how this kind of ANOVA works behind the scenes.
