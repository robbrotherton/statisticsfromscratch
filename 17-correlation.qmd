...
As before, we can check the $t$ table to find the critical values. Since our little example dataset has five pairs of scores, our degrees of freedom is five minus two, which is three.
